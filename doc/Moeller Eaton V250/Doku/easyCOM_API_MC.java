...
public class easyCOM_API_MC
{
	...
	public static native int MC_Open_ComPort
		(
	...
	public static native int MC_Close_ComPort
		(
			Pointer         handle
		);

	public static native int MC_Open_EthernetPort
		(
			PointerByReference handle,
			String          szIpAddress,
			int             IpPort,
	...
	public static native int MC_Close_EthernetPort
		(
			Pointer         handle
		);
	...
	public static native int MC_GetCurrent_Baudrate
		(
			Pointer         handle,
			IntByReference  baudrate
		);
		
	public static native int MC_Set_UserWaitingTime
		(
			int             timeout_delay
		);

	public static native int MC_Get_UserWaitingTime
		(
			IntByReference  timeout_delay
		);


	public static native int MC_Start_Program
		(
			Pointer         handle,
			byte            net_id,
	...
	public static native int MC_Stop_Program
		(
			Pointer         handle,
			byte            net_id,
			ByteByReference errorcode
	...
	public static native int MC_Read_Clock
		(
			Pointer         handle,
			byte            net_id,
	...
	public static native int MC_Write_Clock
		(
			Pointer         handle,
			byte            net_id,
			ByteByReference year,
	...
	public static native int MC_Read_Object_Value
		(
			Pointer         handle,
			byte            net_id,
			byte            object,
	...
	public static native int MC_Write_Object_Value
		(
			Pointer         handle,
			byte            net_id,
			byte            object,
	...
	public static native int MC_Read_Channel_YearTimeSwitch
		(
			Pointer         handle,
			byte            net_id,
			byte            index,
	...
	public static native int MC_Write_Channel_YearTimeSwitch
		(
			Pointer         handle,
			byte            net_id,
			byte            index,
	...
	public static native int MC_Read_Channel_7DayTimeSwitch
		(
			Pointer         handle,
			byte            net_id,
			byte            index,
	...
	public static native int MC_Write_Channel_7DayTimeSwitch
		(
			Pointer         handle,
			byte            net_id,
			byte            index,
	...
	public static native int MC_Unlock_Device
		(
			Pointer         handle,
			byte            net_id,
			String          szPassword,
	...
	public static native int MC_Lock_Device
		(
			Pointer         handle,
			byte            net_id,
			ByteByReference errorcode
