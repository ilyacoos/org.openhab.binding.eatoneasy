...
public class easyCOM_API {
    ...
    public static native int Open_ComPort(byte com_port_nr, int baudrate);

    public static native int Close_ComPort();

    public static native int Open_EthernetPort(String szIpAddress, int IpPort, int baudrate, byte no_baudrate_scan);

    public static native int Close_EthernetPort();

    public static native int Set_UserWaitingTime(int timeout_delay);

    public static native int Get_UserWaitingTime(IntByReference timeout_delay);

    public static native int GetCurrent_Baudrate(IntByReference baudrate);

    public static native int Start_Program(byte net_id, ByteByReference errorcode);

    public static native int Stop_Program(byte net_id, ByteByReference errorcode);

    public static native int Read_Clock(byte net_id, ByteByReference year, ByteByReference month, ByteByReference day,
            ByteByReference hour, ByteByReference min);

    public static native int Write_Clock(byte net_id, ByteByReference year, ByteByReference month, ByteByReference day,
            ByteByReference hour, ByteByReference min);

    public static native int Read_Object_Value(byte net_id, byte object, short index, byte[] data);

    public static native int Write_Object_Value(byte net_id, byte object, byte index, short length, byte[] data);

    public static native int Read_Channel_YearTimeSwitch(byte net_id, byte index, byte channel, ByteByReference on_year,
    ...
    public static native int Write_Channel_YearTimeSwitch(byte net_id, byte index, byte channel,
    ...
    public static native int Read_Channel_7DayTimeSwitch(byte net_id, byte index, byte channel, ByteByReference DY1,
            ByteByReference DY2, ByteByReference on_hour, ByteByReference on_minute, ByteByReference off_hour,
            ByteByReference off_minute);

    public static native int Write_Channel_7DayTimeSwitch(byte net_id, byte index, byte channel, ByteByReference DY1,
            ByteByReference DY2, ByteByReference on_hour, ByteByReference on_minute, ByteByReference off_hour,
            ByteByReference off_minute);

    public static native int Unlock_Device(byte net_id, String szPassword, ByteByReference errorcode);

    public static native int Lock_Device(byte net_id, ByteByReference errorcode);
